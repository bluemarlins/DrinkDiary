...
object DebugSeeder {
    ...
    private data class Seed(
        ...
        val daysAgo: Long,
        /** Catalog keys from TastingTag, picked to match each record's written note. */
    ...
    private val SEED_RECORDS = listOf(
        Seed(DrinkType.Wine, "몬테스 알파 카베르네 소비뇽", 40000,
            ...
            setOf("full_body", "black_fruit", "ripe_fruit")),
        Seed(DrinkType.Whiskey, "조니워커 블랙 라벨 12년", 50000,
            ...
            setOf("smoky", "vanilla", "sweet", "smooth")),
        Seed(DrinkType.Beer, "기네스 드래프트", 3000,
            ...
            setOf("smooth", "choco_coffee", "bitter", "roast_coffee")),
        Seed(DrinkType.Wine, "1865 싱글 빈야드 카베르네 소비뇽", 45000,
            ...
            setOf("full_body", "smooth", "vanilla", "gentle_finish")),
        Seed(DrinkType.Whiskey, "맥캘란 12년 셰리 오크", 150000,
            ...
            setOf("dried_fruit", "sweet", "smooth")),
        ...
        Seed(DrinkType.Wine, "샤토 딸보 2019", 150000,
            ...
            setOf("leather_earth", "red_fruit", "complex")),
        Seed(DrinkType.Whiskey, "발베니 12년 더블우드", 120000,
            ...
            setOf("sweet", "vanilla", "long_finish", "gentle_finish")),
        Seed(DrinkType.Beer, "하이네켄", 3000,
            ...
            setOf("bitter", "high_carb", "refreshing")),
        Seed(DrinkType.Wine, "투핸즈 엔젤스 쉐어 쉬라즈", 60000,
            ...
            setOf("black_fruit", "ripe_fruit", "spicy")),
        Seed(DrinkType.Whiskey, "글렌피딕 15년", 140000,
            ...
            setOf("citrus", "sweet", "spicy", "jammy")),
        Seed(DrinkType.Beer, "아사히 수퍼드라이", 3000,
            ...
            setOf("clean_finish", "dry_texture", "refreshing", "easy_drinking")),
        Seed(DrinkType.Wine, "돔 페리뇽 빈티지", 350000,
            ...
            setOf("citrus", "bready_yeast", "creamy", "crisp")),
        ...
        Seed(DrinkType.Wine, "클라우디 베이 소비뇽 블랑", 55000,
            ...
            setOf("tropical_fruit", "tart", "crisp", "citrus")),
        ...
        Seed(DrinkType.Beer, "빅 웨이브 골든 에일", 4000,
            ...
            setOf("tropical_fruit", "sweet", "clean_finish", "refreshing")),
        Seed(DrinkType.Wine, "모엣 샹동 임페리얼", 85000,
            ...
            setOf("citrus", "bready_yeast", "tart")),
        Seed(DrinkType.Whiskey, "산토리 가쿠빈", 45000,
            ...
            setOf("sweet", "clean_finish", "light_body")),
        Seed(DrinkType.Beer, "블루문", 3500,
            ...
            setOf("citrus", "sweet", "floral", "smooth")),
        Seed(DrinkType.Wine, "캔달 잭슨 빈트너스 리저브 샤르도네", 45000,
            ...
            setOf("oak", "vanilla", "full_body", "oily")),
        Seed(DrinkType.Whiskey, "야마자키 12년", 350000,
            ...
            setOf("floral", "citrus", "gentle_finish")),
        Seed(DrinkType.Beer, "블랑 1664", 3000,
            ...
            setOf("citrus", "floral", "smooth", "light_body")),
        Seed(DrinkType.Wine, "이기갈 꼬뜨 뒤 론 루즈", 30000,
            ...
            setOf("red_fruit", "spicy", "light_body")),
        Seed(DrinkType.Whiskey, "라프로익 10년", 110000,
            ...
            setOf("peat", "smoky", "saline", "long_finish")),
        Seed(DrinkType.Beer, "스텔라 아르투아", 3000,
            ...
            setOf("bitter", "malty_flavor", "balance", "clean_finish")),
        Seed(DrinkType.Wine, "오퍼스 원 2018", 800000,
            ...
            setOf("black_fruit", "complex", "complex_finish", "full_body")),
        Seed(DrinkType.Whiskey, "우드포드 리저브", 120000,
            ...
            setOf("caramel", "chocolate", "spicy_aroma", "full_body")),
        Seed(DrinkType.Beer, "구스 아일랜드 IPA", 3500,
            ...
            setOf("bitter", "citrus", "hoppy_grass", "piney")),
    )
}
